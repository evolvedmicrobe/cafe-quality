...
namespace Bio
{
    ...
    public static class Alphabets
    {
        ...
        /// <summary>
        /// Just A,C,G,T without any gaps. 
        /// </summary>
        public static readonly NoGapDnaAlphabet NoGapDNA = NoGapDnaAlphabet.Instance;
...
//#endif
            ...
            MapAlphabetToAmbiguousAlphabet(NoGapDnaAlphabet.Instance, AmbiguousDnaAlphabet.Instance);
        ...
        public static IAlphabet GetAmbiguousAlphabet(IAlphabet currentAlphabet)
        {
            if (currentAlphabet == DnaAlphabet.Instance ||
                ...
                currentAlphabet == ProteinAlphabet.Instance || currentAlphabet==NoGapDnaAlphabet.Instance)
            {
