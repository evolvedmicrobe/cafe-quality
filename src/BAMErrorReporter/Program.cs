...
namespace BAMErrorReporter
{
    class MainClass
    {
        ...
        public static void Main (string[] args)
        {
            ...
            Parallel.ForEach (bamNames, bamF => {
                ...
                VariantWriter vwriter = new VariantWriter (fname_prefix + "_all_variants.csv");
                CCSWriter ccsw = new CCSWriter (fname_prefix + "_read_report.csv");
